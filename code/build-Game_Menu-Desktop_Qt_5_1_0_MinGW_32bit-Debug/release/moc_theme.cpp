...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Theme_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 28, 0)
    ...
    "Theme\0on_pushButton_clicked\0\0"
};
...
const QMetaObject Theme::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Theme.data,
      qt_meta_data_Theme,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Theme.stringdata))
